...
public:
    ...
    VideoPlayer(void *parent = nullptr);
    ~VideoPlayer();
...
//函数指针:
    void (*stateChanged)(VideoPlayer *player) = nullptr;
    void (*timeChanged)(VideoPlayer *player) = nullptr;
    void (*initFinished)(VideoPlayer *player) = nullptr;
    void (*playFailed)(VideoPlayer *player) = nullptr;
    void (*frameDecoded)(VideoPlayer *player,
                      uint8_t *data,
                      VideoSwsSpec &spec) = nullptr;
